    ...
    >
      ...
      >
        ...
        <div className="md:w-2/4 w-full px-3 flex flex-col gap-3 justify-center">
          <h5 className="font-extrabold font-poppins text-foreground/90 tracking-wide text-center uppercase text-base">
            {project.projectName}
          </h5>
          <p className="text-center font-poppins text-foreground/85">
